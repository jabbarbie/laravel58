...
<form action="{{ route('penjualan.store') }}" class="form-horizontal" method="POST" id="transaksipenjualan">
    @csrf
    <div class="box-body">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group ">        
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control datepicker" id="tanggal_transaksi" name="tanggal_transaksi" required="required">
                </div>    
            </div>
            ...
            <div class="form-group ">        
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Pelanggan" autofocus required="required">
                </div>    
            </div>
